...
public class MediaPublisher {
    ...
    private VideoHelper mVideoGatherer;
    private AudioHelper mAudioGatherer;
    private MediaEncoder mMediaEncoder;

    private RtmpPublisher mRtmpPublisher;
    public boolean isPublish;

    private AudioHelper.Params audioParams;
    private VideoHelper.Params videoParams;
     ...
     */
    public void init() {
        mVideoGatherer = VideoHelper
                .newInstance(mConfig);
        mAudioGatherer = AudioHelper.newInstance(mConfig);
    ...
    public void setFrameCallback(VideoHelper.FrameCallback frameCallback){
        if (null!=frameCallback){
            mVideoGatherer.setFrameCallback(frameCallback);
        }
    }
     ...
     */
    public void initVideoGatherer(Activity act, SurfaceTexture surfaceTexture) {
        videoParams = mVideoGatherer.initCamera(act, surfaceTexture);
    }
    ...
    private void setListener() {
        mVideoGatherer.setCallback(new VideoHelper.Callback() {
            @Override
        ...
        mAudioGatherer.setCallback(new AudioHelper.Callback() {
            @Override
