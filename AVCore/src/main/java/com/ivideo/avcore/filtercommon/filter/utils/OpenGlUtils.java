 ...
 * @version 1.0.0
 * @createDate 2022/6/16 15:20
 * @description
 * @updateUser hahajing
 * @updateDate 2022/6/16 15:20
 * @updateRemark
 */
public class OpenGlUtils {
    ...
    public static String readShaderFromRawResource(final int resourceId){
        final InputStream inputStream = BaseApplication.Companion.getAppContext().getResources().openRawResource(
                resourceId);
