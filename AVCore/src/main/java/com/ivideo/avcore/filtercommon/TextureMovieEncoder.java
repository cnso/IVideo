...
import com.ivideo.avcore.filtercommon.filter.GPUImageFilter;
import com.ivideo.avcore.filtercommon.filter.NoFilter;
import com.ivideo.avcore.filtercommon.filter.magicfilter.MagicCameraInputFilter;
 ...
 * @version 1.0.0
 * @createDate 2022/6/16 15:38
 * @description
 * @updateUser hahajing
 * @updateDate 2022/6/16 15:38
 * @updateRemark
 */
...
//            type = MagicFilterType.NONE;
    ...
    private AFilter mShowFilter=new NoFilter(BaseApplication.Companion.getAppContext().getResources());
