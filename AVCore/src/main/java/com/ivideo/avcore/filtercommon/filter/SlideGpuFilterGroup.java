...
import com.ivideo.avcore.filtercommon.filter.utils.Constants;
 ...
 * @version 1.0.0
 * @createDate 2022/6/16 15:26
 * @description
 * @updateUser hahajing
 * @updateDate 2022/6/16 15:26
 * @updateRemark
 */
public class SlideGpuFilterGroup {
    ...
    public SlideGpuFilterGroup() {
        initFilter();
        scroller = new Scroller(BaseApplication.Companion.getAppContext());
    }
