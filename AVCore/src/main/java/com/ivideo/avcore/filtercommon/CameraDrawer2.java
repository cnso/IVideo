package com.ivideo.avcore.filtercommon;
...
import com.ivideo.avcore.R;
import com.ivideo.avcore.filtercommon.filter.AFilter;
import com.ivideo.avcore.filtercommon.filter.CameraFilter;
import com.ivideo.avcore.filtercommon.filter.GroupFilter;
import com.ivideo.avcore.filtercommon.filter.MagicBeautyFilter;
import com.ivideo.avcore.filtercommon.filter.NoFilter;
import com.ivideo.avcore.filtercommon.filter.ProcessFilter;
import com.ivideo.avcore.filtercommon.filter.SlideGpuFilterGroup;
import com.ivideo.avcore.filtercommon.filter.WaterMarkFilter;
import com.ivideo.avcore.filtercommon.filter.utils.EasyGlUtils;
import com.ivideo.avcore.filtercommon.utils.MatrixUtils;
 ...
 * @version 1.0.0
 * @createDate 2022/6/16 15:03
 * @description
 * @updateUser hahajing
 * @updateDate 2022/6/16 15:03
 * @updateRemark
 */
public class CameraDrawer2 implements GLSurfaceView.Renderer {
...
//    private MagicAntiqueFilter mBeautyFilter;
    ...
    public CameraDrawer2(Resources resources){
        //初始化一个滤镜 也可以叫控制器
